        ...
        <form action="../php/endereco.php" method="POST">
            ...
            <div class="form-endereco">
                ...
                <input
                    ...
                    name="cidade"
                    id="cidade"
                    placeholder="Ex.: Colinas - TO"
                    value="<?= htmlspecialchars($pedido['cidade'] ?? '') ?>"
                >
                ...
                <input
                    ...
                    name="endereco"
                    id="endereco"
                    placeholder="Ex.: Rua Alegria, 1234"
                ...
                <input
                    ...
                    value="<?= htmlspecialchars($pedido['setor'] ?? '') ?>"
                >
                ...
                <textarea
                    ...
                    id="informacao"
                    maxlength="500"
                    placeholder="Ex.: Portão Vermelho"
                ><?= htmlspecialchars($pedido['informacao_adicional'] ?? '') ?></textarea>
...
function atualizarCampos() {
    ...
    if (retirada.checked) {
        ...
        campos.forEach(campo => {
            ...
            campo.classList.add("campo-desabilitado");
        });
        ...
        campos.forEach(campo => {
            ...
            campo.required = true;
            campo.classList.remove("campo-desabilitado");
        });
