...
$sql = "SELECT id_pedido, observacao FROM pedido WHERE id_usuario = ? AND status = 'Carrinho' LIMIT 1";
...
if ($carrinho) {
    ...
    $sql = "SELECT ip.id_produto, ip.quantidade, ip.preco_unitario, p.nome, p.imagem
    ...
    foreach ($produtos as &$produto) {
        $produto['subtotal'] = $produto['preco_unitario'] * $produto['quantidade'];
